...
export const getAdminCreatedCompaniesAction = createAsyncThunk("/api/company", async ( ) =>{
    try {
        ...
        console.log("SOMETHING WENT WRONG IN FETCH ALL ADMIN CREATED COMPANIES ",error);
